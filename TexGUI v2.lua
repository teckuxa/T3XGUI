...
-- 2. The Toggle Button (Small and sleek)
...
-- 3. The Main c00l Frame (Massive Centered UI)
...
-- Title Label for that "Elite" feel
...
-- Helper to make "c00l" style buttons
...
-- 5. KILL ALL (Developer version: just kills NPCs/Dummies in workspace)
